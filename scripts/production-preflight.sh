...
required=(MEMJEV_DOMAIN MEMJEV_OTLP_ENDPOINT MEMJEV_BACKUP_AGE_RECIPIENT MEMJEV_CREDENTIALS_FILE_HOST MEMJEV_JEV_API_KEY_HOST_FILE MEMJEV_JEV_MODEL MEMJEV_API_IMAGE MEMJEV_WORKER_IMAGE MEMJEV_CADDY_IMAGE MEMJEV_PREVIOUS_API_IMAGE MEMJEV_PREVIOUS_WORKER_IMAGE)
