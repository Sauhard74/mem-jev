...
func TestRetrievalMigrationDefinesProductionInvariants(t *testing.T) {
	...
	required := []string{
		...
		"DEFINE TABLE IF NOT EXISTS retrieval_serving_config SCHEMAFULL",
		"DEFINE TABLE IF NOT EXISTS retrieval_serving_head SCHEMAFULL",
		"DEFINE TABLE IF NOT EXISTS retrieval_run SCHEMAFULL",
		"DEFINE TABLE IF NOT EXISTS retrieval_channel_result SCHEMAFULL",
